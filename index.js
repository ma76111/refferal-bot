...
// معالج طريقة العمل - يدعم جميع اللغات
bot.onText(/📖 طريقة العمل|📖 How It Works|📖 Как это работает/, async (msg) => {
  if (msg.handled) return; // تم حظر المستخدم
  
  const user = await User.findByTelegramId(msg.from.id);
  const lang = user?.language || 'ar';
  
  logCommand('📖 How It Works', msg.from.id, msg.from.username);
...
🎯 **نظام البوت:**
هذا بوت لتبادل الإحالات والمهام المدفوعة. يمكنك كسب المال أو الحصول على إحالات لبوتك!

━━━━━━━━━━━━━━━━━━

💰 **المهام المدفوعة:**

1️⃣ **إنشاء مهمة مدفوعة:**
   • اضغط "➕ إضافة مهمة"
   • اختر "💵 مهمة مدفوعة"
   • أدخل اسم البوت ورابط الإحالة
   • حدد المكافأة لكل شخص (USDT)
   • حدد عدد الأشخاص المطلوبين
   • اختر نوع الإثبات المطلوب

2️⃣ **تنفيذ مهمة مدفوعة:**
   • اضغط "📋 المهام المتاحة"
   • اختر مهمة مدفوعة
   • افتح رابط الإحالة وسجل
   • أرسل الإثبات (نص/صور)
   • انتظر المراجعة
   • احصل على المكافأة عند القبول ✅

━━━━━━━━━━━━━━━━━━

🔄 **تبادل الإحالات:**

1️⃣ **إنشاء مهمة تبادل:**
   • اضغط "➕ إضافة مهمة"
   • اختر "🔄 تبادل إحالات"
   • أدخل اسم البوت ورابط الإحالة
   • حدد عدد الأشخاص المطلوبين
...
2️⃣ **تنفيذ مهمة تبادل:**
   • نفذ مهام الآخرين لتحصل على نقاط (+1)
   • استخدم النقاط لتحصل على إحالات لبوتك
   • كل إحالة تحصل عليها = -1 نقطة

━━━━━━━━━━━━━━━━━━

📝 **نظام الإثبات:**

• **نص فقط:** أرسل معرف التليجرام أو اسم المستخدم
• **صور فقط:** أرسل حتى 3 صور للإثبات
• **نص + صور:** أرسل نص ثم صور (حتى 3)

⚠️ **ملاحظات مهمة:**
• لا يمكن تنفيذ نفس المهمة مرتين
• الإثباتات تُراجع من الإدارة
• الإثبات المرفوض يمكن تحسينه خلال المهلة
• الإثبات الكاذب يؤدي للحظر
...
• اضغط "💳 إيداع USDT"
• اختر Binance Pay ID
• أدخل البيانات وأرسل صورة التحويل
• انتظر الموافقة من الإدارة

**السحب:**
• اضغط "💸 سحب USDT"
• اختر Binance Pay ID أو عنوان المحفظة
• أدخل المبلغ والبيانات
• انتظر معالجة الطلب
...
• قيّم المستخدمين بعد إتمام المهام
• التقييم يساعد الآخرين في اختيار المهام
• التقييم السيء يؤثر على سمعة المستخدم

━━━━━━━━━━━━━━━━━━

🚫 **نظام المخالفات:**

• الإثبات الكاذب = مخالفة
• المخالفات المتكررة = حظر مؤقت
• الحظر الدائم للمخالفات الخطيرة
• يمكن الاستئناف من "📝 استئناف"

━━━━━━━━━━━━━━━━━━

⚠️ **البوت تحت التجربة (Beta)**
إذا واجهت أي مشكلة، تواصل مع الدعم من "💬 الدعم"

🎉 **ابدأ الآن واكسب المال!**
  `,
    en: `
📖 **How Does the Bot Work?**

🎯 **Bot System:**
This is a referral exchange and paid tasks bot. You can earn money or get referrals for your bot!

━━━━━━━━━━━━━━━━━━

💰 **Paid Tasks:**

1️⃣ **Create Paid Task:**
   • Click "➕ Add Task"
   • Choose "💵 Paid Task"
   • Enter bot name and referral link
   • Set reward per person (USDT)
   • Set number of people required
   • Choose proof type required

2️⃣ **Complete Paid Task:**
   • Click "📋 Available Tasks"
   • Choose a paid task
   • Open referral link and register
   • Send proof (text/images)
   • Wait for review
   • Get reward upon approval ✅

━━━━━━━━━━━━━━━━━━

🔄 **Referral Exchange:**

1️⃣ **Create Exchange Task:**
   • Click "➕ Add Task"
   • Choose "🔄 Referral Exchange"
   • Enter bot name and referral link
   • Set number of people required
   • Choose proof type required

2️⃣ **Complete Exchange Task:**
   • Complete others' tasks to get points (+1)
   • Use points to get referrals for your bot
   • Each referral you get = -1 point

━━━━━━━━━━━━━━━━━━

📝 **Proof System:**

• **Text Only:** Send Telegram ID or username
• **Images Only:** Send up to 3 proof images
• **Text + Images:** Send text then images (up to 3)

⚠️ **Important Notes:**
• Cannot complete same task twice
• Proofs are reviewed by administration
• Rejected proof can be improved within deadline
• False proof leads to ban
...
**Deposit:**
• Click "💳 Deposit USDT"
• Choose Binance Pay ID
• Enter details and send transfer screenshot
• Wait for admin approval

**Withdrawal:**
• Click "💸 Withdraw USDT"
• Choose Binance Pay ID or wallet address
...
• Ratings help others choose tasks
• Bad ratings affect user reputation

━━━━━━━━━━━━━━━━━━

🚫 **Violation System:**

• False proof = violation
• Repeated violations = temporary ban
• Permanent ban for serious violations
• Can appeal from "📝 Appeal"

━━━━━━━━━━━━━━━━━━

⚠️ **Bot in Beta Testing**
If you face any issues, contact support from "💬 Support"
...
🎯 **Система бота:**
Это бот для обмена рефералами и платных задач. Вы можете зарабатывать деньги или получать рефералов для своего бота!

━━━━━━━━━━━━━━━━━━

💰 **Платные задачи:**

1️⃣ **Создать платную задачу:**
   • Нажмите "➕ Добавить задачу"
   • Выберите "💵 Платная задача"
   • Введите имя бота и реферальную ссылку
   • Установите награду за человека (USDT)
   • Установите количество требуемых людей
   • Выберите требуемый тип доказательства

2️⃣ **Выполнить платную задачу:**
   • Нажмите "📋 Доступные задачи"
   • Выберите платную задачу
   • Откройте реферальную ссылку и зарегистрируйтесь
   • Отправьте доказательство (текст/изображения)
   • Дождитесь проверки
   • Получите награду после одобрения ✅

━━━━━━━━━━━━━━━━━━

🔄 **Обмен рефералами:**

1️⃣ **Создать задачу обмена:**
   • Нажмите "➕ Добавить задачу"
   • Выберите "🔄 Обмен рефералами"
   • Введите имя бота и реферальную ссылку
   • Установите количество требуемых людей
   • Выберите требуемый тип доказательства

2️⃣ **Выполнить задачу обмена:**
   • Выполняйте задачи других, чтобы получить баллы (+1)
   • Используйте баллы для получения рефералов для вашего бота
   • Каждый реферал, который вы получаете = -1 балл

━━━━━━━━━━━━━━━━━━

📝 **Система доказательств:**

• **Только текст:** Отправьте Telegram ID или имя пользователя
• **Только изображения:** Отправьте до 3 изображений доказательства
• **Текст + изображения:** Отправьте текст, затем изображения (до 3)

⚠️ **Важные примечания:**
• Нельзя выполнить одну и ту же задачу дважды
• Доказательства проверяются администрацией
• Отклоненное доказательство можно улучшить в течение срока
• Ложное доказательство приводит к бану
...
**Пополнение:**
• Нажмите "💳 Пополнить USDT"
• Выберите Binance Pay ID
• Введите данные и отправьте скриншот перевода
• Дождитесь одобрения администратора

**Вывод:**
• Нажмите "💸 Вывод USDT"
• Выберите Binance Pay ID или адрес кошелька
• Введите сумму и данные
• Дождитесь обработки
...
• Оценивайте пользователей после выполнения задач
• Рейтинги помогают другим выбирать задачи
• Плохие рейтинги влияют на репутацию пользователя

━━━━━━━━━━━━━━━━━━

🚫 **Система нарушений:**

• Ложное доказательство = нарушение
• Повторные нарушения = временный бан
• Постоянный бан за серьезные нарушения
• Можно подать апелляцию из "📝 Апелляция"

━━━━━━━━━━━━━━━━━━

⚠️ **Бот в бета-тестировании**
Если у вас возникли проблемы, свяжитесь с поддержкой из "💬 Поддержка"

🎉 **Начните сейчас и зарабатывайте деньги!**
  `
  };

  await bot.sendMessage(msg.chat.id, howItWorksMessages[lang], { parse_mode: 'Markdown' });
});
